    ...
    `}())}
      ...
      `,{vido:t,props:e,templateProps:n})}function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:o,update:s,html:r,schedule:a,Actions:l,PointerAction:h,cache:u,StyleMap:p}=t,f="list-column-header-resizer",m=n.getActions(f),v=n.getActions(f+"-dots");let b,w,_,x,P,T,C;o(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>b=t)),o(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{w=t,s()}));const E=new p({width:""});let D=!1;o(i.subscribe("config.classNames",t=>{_=n.getClass(f,{column:w}),x=n.getClass(f+"-container",{column:w}),P=n.getClass(f+"-dots",{column:w}),T=n.getClass(f+"-dots-dot",{column:w}),s()})),o(i.subscribeAll([`config.list.columns.data.${w.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");C=w.width*n.columns.percent*.01,E.style["--width"]=n.columns.resizer.width+"px",D=n.columns.resizer.inRealTime,i.update("_internal.list.width",C),s()}));let O=[1,2,3,4,5,6,7,8];o(i.subscribe("config.list.columns.resizer.dots",t=>{O=[];for(let e=0;e<t;e++)O.push(e);s()}));let S=C;const A=`config.list.columns.data.${w.id}.width`,I={column:w,api:n,state:i,pointerOptions:{axis:"x",onMove:function onMove({movementX:t}){let e=i.get("config.list.columns.minWidth");"number"==typeof w.minWidth&&(e=w.minWidth),S+=t,S<e&&(S=e),D&&i.update(A,S)}}};m.push(h);const z=l.create(m,I),N=l.create(v,I);return n=>b(r`
        <div class=${_} data-actions=${z}>
          ...
          <div class=${P} style=${E} data-actions=${N}>
            ${O.map(t=>r`
                  <div class=${T} />
                `)}
          </div>
